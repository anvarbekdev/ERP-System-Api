	...
	const list = (anchor) => (
		<Box
			...
			<Grid
				...
				<List sx={{ width: "100%" }}>
					<Link to="testPerformance" className="link">
						<ListItem disablePadding>
							<ListItemButton>
								...
								<ListItemText primary={t("test_result")} />
							</ListItemButton>
						</ListItem>
					</Link>
					<Link to="checkAttendence" className="link">
						<ListItem disablePadding>
							<ListItemButton>
								<ListItemIcon
									sx={{
					...
					<Link to="getAllSubjects" className="link">
						<ListItem disablePadding>
							<ListItemButton>
								<ListItemIcon
									sx={{
				...
				{["left"].map((anchor) => (
					<React.Fragment key={anchor}>
						...
						<SwipeableDrawer
							...
							{store.student.isAuthenticated && <>{list("left")}</>}
						</SwipeableDrawer>
					</React.Fragment>
				))}
			</Box>
